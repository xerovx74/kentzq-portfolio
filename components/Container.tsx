...
export default function Container(props) {
  ...
  const router = useRouter();
  const meta = {
    title: 'Debopriya Deb Roy – Tech enthusiastic, CSE student',
    description: `Tech enthusiastic, CSE studentc`,
    image: 'public/static/favicons/banner.png',
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 ">
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://debopriyadebroy.vercel.app${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://debopriyadebroy.vercel.app${router.asPath}`}
        />
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center justify-between w-full relative max-w-4xl border-gray-200 dark:border-gray-700 mx-auto pt-8 pb-8 sm:pb-16  text-gray-900 bg-gray-50  dark:bg-gray-900 bg-opacity-60 dark:text-gray-100">
          ...
          <div className="ml-[-0.60rem]">
            ...
            <NavItem href="/personal" text="Personal" />
